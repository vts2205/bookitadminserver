...
export const subadminprofilevalidation = (req, res, next) => {
  //console.log("2222222222222222222222222222222222222222222222222222222222222222222222222222")
  let errors = {},
    reqBody = req.body;
  console.log("reqbody", reqBody);
  ...
  if (isEmpty(reqBody.password)) {
    errors.password = "Passwordr is required";
  }
  // console.log(errors,"++++++++++++++++++++++++++++++++++++++++++++++++++++");
  if (!isEmpty(errors)) {
    return res.status(400).json({ errors: errors });
...
export const driverprofilevalidation = (req, res, next) => {
  //console.log("2222222222222222222222222222222222222222222222222222222222222222222222222222")
  let errors = {},
    reqBody = req.body;
  console.log("reqbody", reqBody);
